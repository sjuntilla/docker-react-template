...
import { getCards, addCard, deleteCard, editCard } from './actions';
import { Column } from './components/column.jsx';
// import { Kanbancard } from './components/card.jsx';
...
class App extends Component {
  ...
  render() {
    ...
    console.log('rendering', this.props.cards)
    return (
      <div id="main">
        <div>
          <Navbar />
...
//     return (
//       <Grid container direction="row" justify="center" spacing={24} wrap="nowrap">
//         <div><h1>Add New Task</h1>
//           <form id="form" onSubmit={this.addCard}>
...
//   return (
//     <div className={props.status} draggable='true'>
//       <b>{props.title}</b> <br />
//       {props.message} <br />
